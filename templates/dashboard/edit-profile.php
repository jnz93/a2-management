...
<form class="woocommerce-EditAccountForm edit-account" action="" method="post" <?php do_action( 'woocommerce_edit_account_form_tag' ); ?> >
	...
	<ul class="nav nav-tabs" id="myTab" role="tablist">
		...
		<?php if( current_user_can( 'a2_scort') ): ?>
			...
			<li class="nav-item" role="presentation">
				<button class="nav-link" id="service-tab" data-bs-toggle="tab" data-bs-target="#service-tab-pane" type="button" role="tab" aria-controls="service-tab-pane" aria-selected="false"><i class="bi bi-clock-fill me-1"></i></i><?php _e('Atendimento', 'textdomain'); ?></button>
			</li>
			<li class="nav-item" role="presentation">
