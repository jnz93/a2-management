...
<form class="woocommerce-EditAccountForm edit-account mt-5" action="" method="post" enctype="multipart/form-data" <?php do_action( 'woocommerce_edit_account_form_tag' ); ?> >
